        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 text-sm bg-white"
            >
              ...
              <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-10 max-h-52 overflow-y-auto">
                {suggestions.map((product) => {
                  ...
                  return (
                    <div
                      key={product.id}
                      className="px-3 py-2 border-b border-gray-100 last:border-0 hover:bg-blue-50 cursor-pointer transition-colors"
                    ...
                    >
                      <div className="flex items-center justify-between gap-2">
                        ...
                        {product.category_name && (
                          <span className="shrink-0 px-1.5 py-0.5 rounded text-[10px] font-semibold bg-blue-50 text-blue-700">
                            {product.category_name}
                          </span>
                        )}
                      </div>
