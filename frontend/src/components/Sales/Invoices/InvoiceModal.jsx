  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        {showInvoiceList && customerInvoices.length > 1 && (
          <div className="border-b border-gray-200 bg-gray-50 p-4">
            <h3 className="font-semibold text-gray-800 mb-3">All Invoices for {invoice.customer_name}</h3>
        ...
        <div className="p-8 print:p-0">
          ...
          <div className="grid grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm font-semibold text-gray-700">Bill to: <span className="font-bold text-gray-900">{invoice.customer_name}</span></p>
