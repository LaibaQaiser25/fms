        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              <MapPin className="text-red-700 mx-auto mb-4" size={40} />
            ...
            {/* Phone Card */}
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              <Phone className="text-gray-700 mx-auto mb-4" size={40} />
            ...
            {/* Email Card */}
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              <Mail className="text-red-900 mx-auto mb-4" size={40} />
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              {submitted ? (
                <div className="bg-red-50 p-8 rounded-lg text-center">
                  ...
                  <p className="text-red-800 font-semibold">Message sent! We'll contact you shortly.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-red-700 to-red-900 text-white py-3 rounded-lg font-bold hover:shadow-lg transition flex items-center justify-center gap-2"
                  >
            ...
            <div>
              ...
              <div className="mt-8 bg-gray-50 p-8 rounded-lg border-l-4 border-red-700">
                <h3 className="font-bold text-lg mb-2 text-gray-900">Quick Response</h3>
